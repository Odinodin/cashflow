...
{{
var G__13271 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13271;
continue;
}
} else
...
{var pred__13275 = cljs.core._EQ_;var expr__13276 = limit;if(cljs.core.truth_(pred__13275.call(null,1,expr__13276)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13275.call(null,2,expr__13276)))
...
var G__13278 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13279 = (limit__$1 - 1);
var G__13280 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13278;
limit__$1 = G__13279;
parts = G__13280;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13282 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13282))
{var replacement_13283 = temp__4090__auto___13282;buffer.append([cljs.core.str(replacement_13283)].join(''));
} else
{buffer.append(ch);
}
{
var G__13284 = (index + 1);
index = G__13284;
continue;
}
}
