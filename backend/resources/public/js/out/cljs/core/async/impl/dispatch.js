...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13101 = 0;while(true){
var m_13102 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13102 == null))
{} else
{m_13102.call(null);
if((count_13101 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13103 = (count_13101 + 1);
count_13101 = G__13103;
continue;
}
} else
{}
