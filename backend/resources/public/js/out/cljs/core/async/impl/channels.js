...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13107 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13107 = (function (val,box,meta13108){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13107.cljs$lang$type = true;
cljs.core.async.impl.channels.t13107.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13107";
cljs.core.async.impl.channels.t13107.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t13107");
});
cljs.core.async.impl.channels.t13107.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13107.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13109){var self__ = this;
var _13109__$1 = this;return self__.meta13108;
});
cljs.core.async.impl.channels.t13107.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13109,meta13108__$1){var self__ = this;
var _13109__$1 = this;return (new cljs.core.async.impl.channels.t13107(self__.val,self__.box,meta13108__$1));
});
cljs.core.async.impl.channels.__GT_t13107 = (function __GT_t13107(val__$1,box__$1,meta13108){return (new cljs.core.async.impl.channels.t13107(val__$1,box__$1,meta13108));
});
}
return (new cljs.core.async.impl.channels.t13107(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13110 = self__.takes.pop();if((taker_13110 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13110))
{var take_cb_13111 = cljs.core.async.impl.protocols.commit.call(null,taker_13110);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13111,taker_13110){
return (function (){return take_cb_13111.call(null,null);
});})(take_cb_13111,taker_13110))
);
} else
{}
{
