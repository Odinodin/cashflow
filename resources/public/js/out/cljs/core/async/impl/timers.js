...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13066 = 0;while(true){
if((i_13066 < arr.length))
{(arr[i_13066] = null);
{
...
{var i_13073 = (self__.level + 1);while(true){
if((i_13073 <= (new_level + 1)))
{(update[i_13073] = self__.header);
{
var G__13074 = (i_13073 + 1);
i_13073 = G__13074;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13075 = 0;while(true){
if((i_13075 <= self__.level))
{var links_13076 = (update[i_13075]).forward;if(((links_13076[i_13075]) === x__$1))
{(links_13076[i_13075] = (x__$1.forward[i_13075]));
{
var G__13077 = (i_13075 + 1);
i_13075 = G__13077;
continue;
}
} else
{{
var G__13078 = (i_13075 + 1);
i_13075 = G__13078;
continue;
}
}
